...
<html lang="id">
    <head>
        ...
        <script>
            ...
            })(window, document, 'script', 'dataLayer', 'GTM-W7KJ87MQ');
        </script>
        ...
        <noscript>
            <img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=968918320835799&ev=PageView&noscript=1" />
        </noscript>
        <!-- End Meta Pixel Code -->
    </head>
    <body inmaintabuse="1"> 
                                            ...
                                            <div class="flex-shrink-0 group block mt-8">
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="ml-4">
                                                        ...
                                                        <div class="-mt-1">
                                                            <span class="text-sm rounded-full font-medium text-white">maps.twitch225@gmail.com</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="max-w-7xl mx-auto py-2 px-5">
                                <div class="flex items-center justify-between flex-wrap">
                                    ...
                                    <a href="https://ayopppk.com/user/paket">
                                        ...
                                        <p class="mt-1 font-medium text-xs text-gray-700">Beli Paket</p>
                                    </a>
                                    <a href="https://ayopppk.com/user/paket/saya">
                                        ...
                                        <p class="mt-1 font-medium text-xs text-gray-700">Paket Saya</p>
                                    </a>
                                    <a href="https://ayopppk.com/user/tryout-event">
                                        ...
                                        <p class="mt-1 font-medium text-xs text-gray-700">Try Out Akbar</p>
                                    </a>
                                    <button>
                                        <div class="w-full flex justify-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="text-gray-700 h-6 w-6">
                                        ...
                                        <p class="mt-1 font-medium text-xs text-gray-700">Akun</p>
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col flex-grow border-r border-gray-200 pt-5 pb-4 bg-white overflow-y-auto">
                            ...
                            <div class="mt-5 flex-grow flex flex-col">
                                <nav class="flex-1 px-2 bg-white space-y-1">
                                    <a href="https://ayopppk.com/user" class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                                    ...
                                    <a href="https://ayopppk.com/user/pembelian" class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="text-gray-400 group-hover:text-gray-500 mr-3 h-6 w-6">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path>
                                        </svg> Pembelian </a>
                                    <a href="https://ayopppk.com/user/paket/saya" class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="text-gray-400 group-hover:text-gray-500 mr-3 h-6 w-6">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z"></path>
                                        </svg> Paket Saya </a>
                                    <a href="https://ayopppk.com/user/tryout-event" class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
